    ...
    Column {
        ...
        Button {
            ...
            contentItem: Image {
                ...
                source: "file:./imgs/video-player.png" // Specify the path to your PNG icon
        ...
        Button {
            ...
            contentItem: Image {
                source: "file:./imgs/person.png" // Specify the path to your PNG icon
        ...
        Button {
            ...
            // Use an Image instead of text
            contentItem: Image {
                source: "file:./imgs/people.png" // Specify the path to your PNG icon
                fillMode: Image.PreserveAspectFit // Preserve the aspect ratio of the icon
